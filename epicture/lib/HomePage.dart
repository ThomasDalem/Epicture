...
class _HomePageState extends State<HomePage> {
  ...
  void getGalleryImageWithoutSearchQuery() {
    ...
    http.get("https://api.imgur.com/3/gallery/" + _sectionTitleItem[_sectionValue] + "/" + _sortTitleItem[_sortValue] + "/" + _windowTitleItem[_windowValue] + "/",
  ...
  void getGalleryImageWithSearchQuery() {
    ...
    http.get("https://api.imgur.com/3/gallery/search/" + _sortTitleItem[_sortValue] + "/" + _windowTitleItem[_windowValue] + "/?q=" + userInfos.querySearchImage,
        headers: {"Authorization": "Bearer ${userInfos.accessToken}"}).then((response) {
      if (response.statusCode == 200) {
        setState(() {
          _images = parseData(response.body).data;
